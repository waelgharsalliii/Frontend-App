...
export default function UpdateClub() {
    ...
    if (logo) {
      formData.append("logo", logo, logo.name);
        ...
        const response = await fetch(`http://localhost:3001/clubs/update/${ClubId}`, {
          method: "PUT",
          body: formData
        });
        if (response.ok) {
          ...
          console.error(`Failed to update club: ${response.status} ${response.statusText}`);
        }
      };
            ...
            <div className="card-body p-0">
                ...
                <div className="row">
                    <div className="col-lg-5 d-none d-lg-block">
                        <img src={process.env.PUBLIC_URL + `/img/${logo}`} alt="logo" width={500} />
                    </div>
                        ...
                        <div className="p-5">
                            ...
                            <form className="user" onSubmit={ClubFormHandler}>
                                ...
                                <div className="form-group row">
                                    ...
                                    <label>Logo</label>
                                        <input type="file"
                                            id="exampleInputPassword" placeholder="Logo" onChange={handleLogoChange} />
                                    </div>
                                </div>
                                <hr />
