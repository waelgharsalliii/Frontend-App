  ...
  const [profilePic, setProfilePic] = useState("");
    ...
    const LogoutHandler = () => {
      ...
      const fetchData = async () => {
        try {
          ...
          const response = await fetch(`http://localhost:3001/clubs/${ClubId}/members`,{
            method:"GET"
    ...
    useEffect(() => {
      ...
      const DeleteHandler = async (e, user) => {
        e.preventDefault();
        const ClubId=localStorage.getItem("ClubId");
        await fetch(`http://localhost:3001/clubs/${ClubId}/${user._id}/leave`, {
          method: "DELETE",
        });
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th className="details">Remove Member</th>
                </tr>
              </thead>
              <tbody>
                  { members.map((user) => (
                ...
                <div className="text-center" style={{ marginTop: "90px" }}>
                  ...
                  <p className="lead text-gray-800 mb-5">No Members Found</p>
                  <p className="text-gray-500 mb-0">
                    It looks like you should add some Members...
                  </p>
                  <NavLink to="/Dash">
